...
def tabela_dataframe_combined_data(container):
    ...
    st.markdown("<div style='text-align: center;'><h2>Link do Repositório no GitHub</h2>"
                "<a href='https://github.com/LuisHengs/PISI3' target='_blank'>Repositório do Projeto</a></div>",
                unsafe_allow_html=True)
