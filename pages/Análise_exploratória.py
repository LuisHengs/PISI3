...
st.title('Análise exploratória dos Dataframe.')
st.subheader('Selecione o a anaálise que você quer ver.')

def pagina1():
    st.title("Página 1 - Tópico A")
    st.write("Conteúdo relacionado ao tópico A")
...
pagina_selecionada = st.selectbox("Selecione uma página", ("Página 1", "Página 2", "Página 3", "Página 4"))
